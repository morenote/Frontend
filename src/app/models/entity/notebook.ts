import { NotebookType } from "../enum/notebook-type";
import {NotebookOwnerType} from "../enum/notebook-owner-type";
 ...
 */
 export class Notebook {
  ...
  public NotebookType: NotebookType | undefined ;//仓库类型 笔记仓库、文件仓库
  public NotebookOwnerType: NotebookOwnerType | undefined ;//仓库拥有者类型
